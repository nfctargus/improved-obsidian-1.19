...
public class ObsideriteChestScreen extends HandledScreen<ObsideriteChestScreenHandler> {
    ...
    private static final Identifier TEXTURE =
            new Identifier(ImprovedObsidianMod.MOD_ID, "textures/gui/obsiderite_chest_gui.png");

    public ObsideriteChestScreen(ObsideriteChestScreenHandler handler, PlayerInventory inventory, Text title) {
